...
public class Start {
	...
	public Start() {
		...
		osobe[3]= new Predavac(1,"Pavle","Vidakovic",new BigDecimal(100),new BigDecimal(50));
		ispisiCijene(osobe);
	}
	
   public void ispisiCijene(Osoba[]osobe) {
	   BigDecimal ukupno = BigDecimal.ZERO;
	   for(Osoba o:osobe) {
		   System.out.println(o.getIme() + " " + o.getPrezime() + ": " + o.getUkupno()); // polimorfizam -viseoblicje
